...
app.get('/api/analytics/link-activity', async (req, res) => {
  try {
...
app.get('/api/dashboard/automation-overview', async (req, res) => {
  try {
...
app.get('/api/dashboard/top-campaigns', async (req, res) => {
  try {
...
app.get('/api/email-analytics', handleEmailAnalytics);
app.get('/email-analytics', handleEmailAnalytics);
